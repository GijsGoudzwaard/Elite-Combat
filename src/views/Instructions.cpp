...
void Instructions::build() {
  ...
  image.build("instructions/cdown.bmp", 60, 135);         // downside
  image.build("instructions/cup.bmp", 60, 70);            // upside
  image.build("instructions/hit.bmp", 185, 60);           // c
  image.build("instructions/kick.bmp", 185, 170);         // z
